    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav me-auto mobile-nav-menu">
                ...
                <?php if ($role == 'Admin'): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= $base_url ?>jadwal/index.php">
                            <i class="bi bi-calendar-event"></i> Kelola Jadwal
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= $base_url ?>pengguna/index.php">
                            <i class="bi bi-people"></i> Kelola Pengguna
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= $base_url ?>insiden/index.php">
                            <i class="bi bi-exclamation-circle"></i> Catatan Insiden
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= $base_url ?>presensi/index.php">
...
<div class="container-fluid">
    <div class="row">
        ...
        <!-- SIDEBAR DESKTOP -->
        <div class="col-md-3 col-lg-2 px-0 sidebar d-none d-md-block" id="sidebarMenu">
